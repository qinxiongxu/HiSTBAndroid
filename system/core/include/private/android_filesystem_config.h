...
static const struct fs_path_config android_files[] = {
    ...
    { 00550, AID_ROOT,      AID_SHELL,     0, "system/etc/init.bigfish.sh" },
    ...
    { 00550, AID_DHCP,      AID_SHELL,     0, "system/etc/dhclient*" },
    { 00444, AID_RADIO,     AID_AUDIO,     0, "system/etc/AudioPara4.csv" },
    { 00555, AID_ROOT,      AID_ROOT,      0, "system/etc/ppp/*" },
    { 00555, AID_ROOT,      AID_ROOT,      0, "system/etc/rc.*" },
    { 00555, AID_ROOT,      AID_ROOT,      0, "system/etc/restore" },
    { 00555, AID_ROOT,      AID_ROOT,      0, "system/etc/security_l2_num" },
