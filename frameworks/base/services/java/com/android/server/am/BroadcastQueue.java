...
public final class BroadcastQueue {
    ...
    static final int MAX_BROADCAST_HISTORY = (ActivityManager.isLowRamDeviceStatic()
        && ("512m".equals(ActivityManager.getMemorySizeStatic()) || "768m".equals(ActivityManager.getMemorySizeStatic()))) ? 20 : 50;
    static final int MAX_BROADCAST_SUMMARY_HISTORY = (ActivityManager.isLowRamDeviceStatic()
        && ("512m".equals(ActivityManager.getMemorySizeStatic()) || "768m".equals(ActivityManager.getMemorySizeStatic()))) ? 50 : 300;
