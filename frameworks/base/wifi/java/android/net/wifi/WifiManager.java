...
public class WifiManager {
  ...
  /**
    ...
    */
    public void setDhcpOption60(boolean enable, String login, String password) {
        try {
            ...
            Log.e(TAG, "setDhcpOption60(" + enable + ", " + login + ", " + password + ") ERROR!");
        }
    }
    ...
    */
    public void setDhcpOption125(boolean enable, String option125Info) {
        try {
            ...
            Log.e(TAG, "setDhcpOption125(" + enable + ", " + option125Info + ") ERROR!");
        }
    }
   ...
   /**
     ...
     * @hide
     */
    public boolean startWifiWithoutLinkDown() {
        try {
            mService.startWifiWithoutLinkDown();
            return true;
        } catch (RemoteException e) {
            return false;
        }
    ...
    /**
     * Disconnect from a network (if any) but do not linkdown wlan0.
     *
     * This API is used by WifiStateTracker
     *
     * @return {@code true} if the operation succeeds else {@code false}
     * @hide
     */
    public boolean stopWifiWithoutLinkDown() {
        try {
            mService.stopWifiWithoutLinkDown();
            return true;
        } catch (RemoteException e) {
            return false;
        }
