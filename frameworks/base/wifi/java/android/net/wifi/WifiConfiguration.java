...
public class WifiConfiguration implements Parcelable {
    ...
    /** @hide */
    public static final int DISABLED_PPPOE_AUTH_FAILURE                     = 5;
    /**
    ...
    /**
     * Support 2.4G band and 5G band channel.
     */
    public int channel;
    ...
    public String dhcpplusUsername;
    public String dhcpplusPassword;
    ...
    public String toString() {
        ...
        sbuf.append("\n");
        sbuf.append("Pppoe username: " + this.pppoeUsername);
        sbuf.append("\n");
        sbuf.append("Pppoe pppoePasswd: " + this.pppoePasswd);
        sbuf.append("\n");
        sbuf.append("Dhcpplus username: " + this.dhcpplusUsername);
        sbuf.append("\n");
        sbuf.append("Dhcpplus Password: " + this.dhcpplusPassword);
        sbuf.append("\n");
    ...
    */
    ...
    public WifiConfiguration(WifiConfiguration source) {
        if (source != null) {
            ...
            pppoeUsername = source.pppoeUsername;
            pppoePasswd = source.pppoePasswd;
            dhcpplusUsername = source.dhcpplusUsername;
            dhcpplusPassword = source.dhcpplusPassword;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(pppoeUsername);
        dest.writeString(pppoePasswd);
        dest.writeString(dhcpplusUsername);
        dest.writeString(dhcpplusPassword);
    }
    ...
    public static final Creator<WifiConfiguration> CREATOR =
        new Creator<WifiConfiguration>() {
            public WifiConfiguration createFromParcel(Parcel in) {
                ...
                config.pppoeUsername = in.readString();
                config.pppoePasswd = in.readString();
                config.dhcpplusUsername = in.readString();
                config.dhcpplusPassword = in.readString();
