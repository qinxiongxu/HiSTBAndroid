...
interface IWifiManager
{
    ...
    int getDhcpOption60State();
    String getDhcpOption60Login();
    String getDhcpOption60Password();
    void setDhcpOption60(boolean setEnable, String login, String password);
    int getDhcpOption125State();
    String getDhcpOption125Info();
    void setDhcpOption125(boolean setEnable, String option125Info);
    ...
    void stopWifiWithoutLinkDown();

    void startWifiWithoutLinkDown();
