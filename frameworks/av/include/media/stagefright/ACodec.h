...
private:
    ...
    sp<ANativeWindow> mLocalNativeWindow;
    SoftwareRenderer  *mRender;
    ...
    status_t setupFFmpegAudioFormat(const sp<AMessage> &msg, const char *mime);
