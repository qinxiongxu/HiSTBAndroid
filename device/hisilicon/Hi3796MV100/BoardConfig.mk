...
# SDK configure
HISI_SDK_ANDROID_CFG := hi3796mdmo1a_hi3796mv100_android_cfg.mak
HISI_SDK_SECURE_CFG := hi3796mdmo1a_hi3796mv100_android_security_cfg.mak
HISI_SDK_RECOVERY_CFG := hi3796mdmo1a_hi3796mv100_android_recovery_cfg.mak
SDK_CFG_DIR := configs/hi3796mv100
...
# Kernel configure
RAMDISK_ENABLE := true
ANDROID_KERNEL_CONFIG := hi3796mv100_android_defconfig
RECOVERY_KERNEL_CONFIG := hi3796mv100_android_recovery_defconfig


# emmc fastboot configure
EMMC_BOOT_CFG_NAME := hi3796mdmo1a_hi3796mv100_ddr3_1gbyte_16bitx2_4layers_emmc.cfg
EMMC_BOOT_REG_NAME := hi3796mdmo1a_hi3796mv100_ddr3_1gbyte_16bitx2_4layers_emmc.reg
EMMC_BOOT_ENV_STARTADDR :=0x100000
EMMC_BOOT_ENV_SIZE=0x10000
EMMC_BOOT_ENV_RANGE=0x10000

# nand fastboot configure
NAND_BOOT_CFG_NAME := hi3796mdmo1a_hi3796mv100_ddr3_1gbyte_16bitx2_4layers_nand.cfg
NAND_BOOT_REG_NAME := hi3796mdmo1a_hi3796mv100_ddr3_1gbyte_16bitx2_4layers_nand.reg
...
#apploader config
APPLOADER_CFG := hi3796mdmo1a_hi3796mv100_apploader_cfg.mak
APPLOADER_KERNEL_CONFIG := hi3796mv100_loader_defconfig
...
# if RTL8723BU is set to y, must modify device\hisilicon\Hi3796MV100\Hi3796MV100.mk as follows:
# BOARD_BLUETOOTH_DEVICE_REALTEK := y
# if RTL8723BU is set to n,must modify BOARD_BLUETOOTH_DEVICE_REALTEK := n
# if MT7632U is set to y, must modify device\hisilicon\Hi3796MV100\etc\init.Hi3796MV100.rc as follows:
