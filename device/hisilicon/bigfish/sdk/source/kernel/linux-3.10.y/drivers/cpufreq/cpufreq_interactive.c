...
#define DEFAULT_BOOSTPULSE_DURATION_TIME (800 * USEC_PER_MSEC)
...
void cpufreq_interactive_boost(void)
{
	int i;
	int anyboost = 0;
	unsigned long flags;
		...
		unsigned int event)
{
	...
	case CPUFREQ_GOV_POLICY_INIT:
		...
		tunables->boostpulse_duration_val = DEFAULT_BOOSTPULSE_DURATION_TIME;
