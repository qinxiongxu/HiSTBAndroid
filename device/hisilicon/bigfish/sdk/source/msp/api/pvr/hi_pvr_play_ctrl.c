...
#if 0
/*
用于获取芯片解码能力， 即 1S 能解码的 帧数 (1080p HD)；
实际上每秒钟能解码的帧数将根据实际图像的分辨率做运算；
例如CV200 的解码能力是 65 (HD)；
则播放720p 的图像的时候，能解码帧数是:
