...
#else//for muti scd
extern SINT32  s_ScdRegPhyBaseAddr[MAX_SCD_NUM];
extern SINT32  s_ScdRegResetPhyAddr[MAX_SCD_NUM];
extern SINT32  s_ScdRegResetOKPhyAddr[MAX_SCD_NUM];
...
/*========================================================================
    part3.    top level
========================================================================*/
SINT32 SM_OpenSCDDrv(SINT32 MemAddr, SINT32 MemSize, SINT32 ScdId);
...
SINT32 ScdDriver(SM_CTRLREG_S *pSmCtrlReg, SM_PUSHRAW_S *pSmPushRaw, SINT32 SegStreamSize,RAW_ARRAY_S *pRawStreamArray,
            SINT32 *pDownMsgVirAddr, SINT32 DownMsgPhyAddr,SINT32 ScdId);
...
SINT32 WriteScdMsg(SM_PUSHRAW_S *pSmPushRaw, SINT32 SegStreamSize, RAW_ARRAY_S *pRawStreamArray,
           SINT32 *pDownMsgVirAddr, SINT32 DownMsgPhyAddr, SINT32 LowdlyFlag,SINT32 ScdId);
...
返回值  无
************************************************************************/
VOID PrintDownMsg(SINT32 DownMsgPhyAddr, SINT32 * pDownMsgVirAddr, SINT32 PushRawNum,SINT32 ScdId);
