...
#define SPEED_SIZE 1048576

typedef struct down_node{
    unsigned int down_size;
    unsigned int down_time;
    int64_t down_starttime;
    int64_t down_endtime;
    struct down_node *next;
}DownNode;

typedef struct down_speed
{
    int64_t down_size;
    int64_t down_time;
    int64_t speed;
...
typedef struct URLContext {
    ...
    int is_connected;
    int64_t int64FileOffset; /* for url: XXX.XX::offset::fileLen mode */
    int64_t int64FileLen; /* for url: XXX.XX::offset::fileLen mode */
...
typedef struct URLProtocol {
    ...
    int64_t (*url_read_seek)(URLContext *h, int stream_index,
                             int64_t timestamp, int flags);
    int (*url_get_seekable)(URLContext * h);
...
extern URLErrorCodeCB *url_errorcode_cb;
...
//z00180556 add for http error callback
attribute_deprecated void url_set_errorcode_cb(URLErrorCodeCB *errorcode_cb);
...
//z00180556
int avio_open_h(AVIOContext **s, const char *filename, int flags,
