...
/** presentation information for mpeg dash or hls*/
typedef struct hiFORMAT_PRESENTATION_INFO_S
{
    HI_FORMAT_DATA_TYPE_E eRepresentationType;
    HI_S32     s32StreamID;/**< adaptationset index for mpeg dash, redition index  for hls */
    HI_S32     s32RepresentIndex;/**< a stream of a different bandwidth, i.e. representation index for mpeg dash*/
    HI_S32     s32BandWidth;
    HI_S32     s32MaxPlayoutRate;/**< for mpeg dash*/
}HI_FORMAT_PRESENTATION_INFO_S;
...
typedef enum hiFORMAT_MSG_TYPE_E
{
    ...
    HI_FORMAT_MSG_REPRESENTATION_CHANGED, /**< representation of hls/dash changed, param type is HI_FORMAT_PRESENTATION_INFO_S*//**< CNcomment:hls/dash stream码率切换,参数类型为HI_FORMAT_PRESENTATION_INFO_S*/
    HI_FORMAT_MSG_WAITING_FOR_STREAMREADY, /**< stream not ready now, need do waiting, param type is HI_SVR_PLAYER_BUFFER_S*//**< CNcomment:码流还没有准备好，需要等待,参数类型为HI_SVR_PLAYER_BUFFER_S*/
    HI_FORMAT_MSG_STREAM_NOT_AVAIABLE, /**< stream not avaiable ,need to stop play*//**< CNcomment:码流不可用，需要停止播放*/
    HI_FORMAT_MSG_CLEAR_LIVE_BUFFER,       /**< the buffer of live stream is full, some buffers cleared *//**< CNcomment:直播数据流满，有数据被清除 */
...
typedef struct hiFORMAT_MSG_S
{
    ...
    HI_VOID  *pPriData;                    /**< parameter of private message, it is valid when eMsgType equal to HI_FORMAT_MSG_USER_PRIVATE/HI_FORMAT_MSG_REPRESENTATION_CHANGED/  *//**< CNcomment:私有信息参数地址,消息为HI_FORMAT_MSG_USER_PRIVATE/HI_FORMAT_MSG_REPRESENTATION_CHANGED，该值有效 */
} HI_FORMAT_MSG_S;
