...
enum CodecID {
    ...
    CODEC_ID_BLURAY_MVCD = MKBETAG('M','V','C','D'),
    CODEC_ID_BLURAY_MVC = MKBETAG('M','V','C','0'),
    /* various PCM "codecs" */
...
#endif
    CODEC_ID_BMV_AUDIO,
    CODEC_ID_AC3_FFMPEG, //z00180556 add for some ac3 use ffmpeg eg.dnet
...
typedef struct AVPacket {
    ...
    /*for use of playready decrypt, when set to 1, force no decrypt*/
    int flg_no_decrypt;
    int bytes_left;    //bytes left when decoder one frame
} AVPacket;
#define AV_PKT_FLAG_KEY     0x0001 ///< The packet contains a keyframe
#define AV_PKT_FLAG_CORRUPT 0x0002 ///< The packet content is corrupted
#define AV_PKT_FLAG_FLUSH   0x0010 ///< The packet content is empty, just for flush
...
#define AV_EF_AGGRESSIVE (1<<18)
    ...
    /*! changed: Raw m1v or m2v I frame time stamp */
    int64_t dwIframeTimeStamp;
    /*! changed: Raw m1v or m2v last time stamp */
...
#else
#define av_log_missing_feature(avc, feature, want_sample)
#define av_log_ask_for_sample(avc, msg, ...)
#endif
