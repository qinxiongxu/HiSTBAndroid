...
import com.hisilicon.android.gallery3d.ui.TileImageViewAdapter;
import com.hisilicon.android.gallery3d.ui.PhotoView.ImageData;
...
public class PhotoDataAdapter implements PhotoPage.Model {
    ...
    private void updateScreenNail(long version, Future<Bitmap> future) {
		...
		//BEGIN set Failed To Load
            mTileProvider.setFailedToLoad();
    ...
    private void updateCurrentIndex(int index) {
        ...
        // Remember a single picture sliding index
        GLView.mCurrrentPhotoSlotIndex = index;
        // end
        mCurrentIndex = index;
        updateSlidingWindow();
