...
//        }
    ...
    public Bitmap nextBitmap() {
        ...
        im = ((GifFrame) frames.elementAt(frameindex)).image;
        return resizedBitmap(im);
    }
    ...
    public int nextDelay() {
        ...
        //DTS2011011804074
        return (frames.size() != 1) ? ((GifFrame) frames.elementAt(frameindex)).delay : 1000;
        //DTS2011011804074
    }
    ...
    public int read(InputStream is) {
        ...
        {
            Log.e("G_DECODE","GifOpenHelper.read OutOfMemoryError Exception ----");
            //e.printStackTrace();
        }
        catch (Exception e) {
            e.printStackTrace();
    ...
    protected void readHeader() {
        ...
        //Z00186359 fix for DTS2011091503566 start
        if(width <= 0 || height <= 0)
        {
            status = STATUS_FORMAT_ERROR;
            return;
        }
        //Z00186359 fix for DTS2011091503566 end
    ...
    protected void readImage() {
        /*add OOM exception catch, free source manual handle*/
        try {
            // offset of X
        ...
        /**end DTS2011092304212 modify by duanqingpeng 2011-11-02 **/
    }
