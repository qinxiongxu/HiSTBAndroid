 ...
 */
public class AudioPreview extends Activity implements OnPreparedListener,
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (scheme.equals(ContentResolver.SCHEME_CONTENT)) {
            if (mUri.getAuthority() == MediaStore.AUTHORITY) {
                ...
                mAsyncQueryHandler.startQuery(0, null, mUri, null, null, null,
                        null);
            }
    ...
    public boolean onError(MediaPlayer mp, int what, int extra) {
        Toast.makeText(this, R.string.playback_failed, Toast.LENGTH_SHORT)
                .show();
        finish();
        return true;
    }
